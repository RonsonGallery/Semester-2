...
public class Test {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 270, 433);
		...
		btnNewButton.setBounds(22, 186, 46, 41);
		...
		btnNewButton_1.setBounds(79, 186, 46, 41);
		...
		btnNewButton_2.setBounds(135, 186, 46, 41);
		...
		btnNewButton_3.setBounds(22, 238, 46, 41);
		...
		btnNewButton_4.setBounds(79, 238, 46, 41);
		...
		btnNewButton_5.setBounds(135, 238, 46, 41);
		...
		btnNewButton_6.setBounds(22, 290, 46, 41);
		...
		btnNewButton_7.setBounds(79, 290, 46, 41);
		...
		btnNewButton_8.setBounds(135, 290, 46, 41);
		...
		btnNewButton_6_1.setBounds(79, 342, 46, 41);
		...
		btnNewButton_6_1_1.setBounds(191, 342, 46, 41);
		...
		btnNewButton_2_2_1.setBounds(191, 290, 46, 41);
		...
		btnNewButton_2_2_1_1.setBounds(191, 238, 46, 41);
		...
		btnNewButton_2_2_1_2.setBounds(191, 186, 46, 41);
		...
		btnNewButton_2_2_1_3.setBounds(135, 342, 46, 41);
		...
		btnNewButton_9.setBounds(22, 74, 46, 41);
		...
		btnNewButton_9_1.setBounds(79, 134, 46, 41);
		...
		btnNewButton_9_2.setBounds(135, 134, 46, 41);
		...
		btnNewButton_9_3.setBounds(191, 134, 46, 41);
		...
		btnNewButton_6_1_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				num = Double.parseDouble(textField.getText());
				textField.setText(Double.toString(num*-1));
			}
		});
		btnNewButton_6_1_2.setBounds(22, 342, 46, 41);
		frame.getContentPane().add(btnNewButton_6_1_2);
		
		JButton btnNewButton_9_1_1 = new JButton("sqrt");
		btnNewButton_9_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				num = Double.parseDouble(textField.getText());
				textField.setText(Double.toString(Math.sqrt(num)));
			}
		});
		btnNewButton_9_1_1.setBounds(67, 74, 63, 41);
		frame.getContentPane().add(btnNewButton_9_1_1);
		
		JButton btnNewButton_9_1_1_1 = new JButton("^2");
		btnNewButton_9_1_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				num = Double.parseDouble(textField.getText());
				textField.setText(Double.toString(num*num));
			}
		});
		btnNewButton_9_1_1_1.setBounds(135, 74, 51, 41);
		frame.getContentPane().add(btnNewButton_9_1_1_1);
		
		JButton btnNewButton_9_1_1_1_1 = new JButton("1/x");
		btnNewButton_9_1_1_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				num = Double.parseDouble(textField.getText());
				textField.setText(Double.toString(1/num));
			}
		});
		btnNewButton_9_1_1_1_1.setBounds(193, 74, 51, 41);
		frame.getContentPane().add(btnNewButton_9_1_1_1_1);
		
		JButton btnNewButton_9_1_2 = new JButton("CE");
		...
		btnNewButton_9_1_2.setBounds(22, 134, 46, 41);
