...
public class RockPaperScissors extends Game {
	...
	protected void initActions() {
		...
		actions[2] = new Action("Scisors");
	}

	protected void rewardPlayers(Action a1, Action a2) {
		if(a1.equals(a2))
			return;
		if(a1.equals(actions[0]) && a2.equals(actions[1])||a1.equals(actions[1]) && a2.equals(actions[0])||a1.equals(actions[2]) && a2.equals(actions[1])) {
